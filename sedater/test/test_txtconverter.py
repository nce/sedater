...
# Modified: Tue, 08.12.2015 - 21:59:36
...
class TestTxtConverter(unittest.TestCase):
    def setUp(self):
        ...
        self.ref = self.tmp.write('txtvalidation.txt', 
                b"Foo, Bar\nFaz, Baz\n1,2\n3,4")
        self.reffile = lib.Sourcefile._make([self.ref, 'txtvalidation.txt', '', '', ''])
    def tearDown(self):
    ...
    def test_correct_txt_file(self):
        ...
        #     {' Baz': '4', 'Faz': '3'}])
        ref = lib.Validationfile._make([inSource, '', [['Foo', 'Bar']],
            [{'Baz': '2', 'Faz': '1'}, {'Baz': '4', 'Faz': '3'}]])
        conv = TxtConverter([])
