...
Documentation
=============
This is a more in-depth developer documentation for the tool.

Refer to the `Github <https://github.com/nce/sedater>`_ repository for an
End-User Documentation with sample runtime instructions and definitions.
